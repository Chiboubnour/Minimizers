...
constexpr int PAR_FACTOR  = 16;
constexpr int SMER_SIZE   = 31;
constexpr int WINDOW_SIZE = 19;
constexpr int SMER_BITS   = 2 * SMER_SIZE;


constexpr int MEM_WIDTH = 8 * PAR_FACTOR;
...
constexpr int AXIS_BITS = 64 * PAR_FACTOR + 8;
