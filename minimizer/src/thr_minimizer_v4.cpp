...
constexpr int Parallel_factor = 32;
...
#pragma HLS INLINE off
    ...
    ap_uint<64> n_words = (n_bases + Parallel_factor - 1) / Parallel_factor;
...
#pragma HLS loop_tripcount min=100 max=100
        ...
        ap_uint<8>  valid;
        if (w == n_words - 1 && (n_bases % Parallel_factor)) {
            valid = n_bases % Parallel_factor;
        } else {
            valid = Parallel_factor;
        }
...
#pragma HLS ARRAY_PARTITION variable=burst_buf complete //C CA QUI POSE PROBLEM !!!!!!!!
